...
perl $EBROOTGUIDANCE/www/Guidance/guidance.pl --program GUIDANCE --seqFile foxl2_all_54.fa --msaProgram PRANK --seqType codon --outDir . --genCode 1 --bootstraps 100 --proc_num 4
