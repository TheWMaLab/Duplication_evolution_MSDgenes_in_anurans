      seqfile = MSA.PRANK.aln.With_Names * sequence data filename
     treefile = MSA.PRANK.aln.With_Names.raxml.bestTree      * tree structure file name
      outfile = outfree        * main result file name
